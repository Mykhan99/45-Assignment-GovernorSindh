...
let famPerson = "Umar Ibn Al Khattab";

let famQoute = "! “We were the most humiliated people on earth & Allah gave us honor through Islam.”"; 

console.log (famPerson, famQoute);