/*Q34 34.	Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in a array,
...
• Add a line at the end of your program, outside the for loop, that states how much you like pizza. 
  ...
  var pizzaNames: string[] =[`Peproni`, `Chicken Tikka`, `Fajita`,`Afghani Feast`];

  for(let pizza of pizzaNames){
    console.log(pizza)
    console.log(`I like ${pizza} pizza`);
  }
console.log(`I enjoy trying different kinds of pizza.`);
console.log(`Pepperoni, Margherita, and BBQ Chicken are some of my favorites.`);
console.log(`But overall, I really love pizza!`);
